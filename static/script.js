...
const translations = {
    en: {
        ...
        'nav.iso17025_certificate': 'ISO 17025 Accreditation',
    ...
    ja: {
        ...
        'nav.iso17025_certificate': 'ISO 17025認可',
        ...
        'quick.detail_open_pdf': '認可書PDFを開く',
        ...
        'certificate.number_label': '認可書番号:',
        'certificate.organization_label': '認定取得組織:',
        'certificate.valid_until_label': '有効期限:',
        'certificate.cards_loading': '認可書情報を読み込み中…',
        'certificate.cards_error': '認可書情報を取得できませんでした。',
        'certificate.cards_retry': '認可書情報の取得を再試行',
